...
async def command_start(message: Message):
    ...
    await message.answer(text='сиськи', reply_markup=InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text='тыкни', url='https://yandex.ru/video/preview/17193376190839247531?text=порно%20с%20конями&path=yandex_search&parent-reqid=1762276638743991-3842274031912798246-balancer-l7leveler-kubr-yp-vla-101-BAL&from_type=carousel')]
    ]))